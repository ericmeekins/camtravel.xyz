...
<h2 class="wp-block-heading has-text-align-center sec-main-heading has-primary-color has-text-color has-link-color has-inika-font-family wow bounceInDown" style="margin-top:0;margin-bottom:0;font-size:18px;font-style:normal;font-weight:400"><?php esc_html_e('POPULAR SERVICES','outdoor-camping'); ?></h2>
<!-- /wp:heading -->
...
<h2 class="wp-block-heading has-text-align-center has-heading-color has-text-color has-link-color has-inika-font-family wow bounceInDown" style="font-size:24px;font-style:normal;font-weight:700"><?php esc_html_e('Amazing Camping For Real Adventure','outdoor-camping'); ?></h2>
<!-- /wp:heading -->
